...
* [PhysicalOptics.jl [WIP]](https://github.com/JuliaPhysics/PhysicalOptics.jl) which allows to write down scalar wave propagation which can be automatic differentiated (AD) by Julia's AD. 
