...
*EPFL · SIGGRAPH (Journal Track)* · [doi.org/10.1145/3811332](https://dl.acm.org/doi/10.1145/3811332)
...
<div style="display:flex; gap:8px; margin: 10px 0 18px 0; flex-wrap:wrap;">
  ...
  <a href="https://dl.acm.org/doi/10.1145/3811332" style="background:#b34430;color:white;padding:5px 12px;border-radius:4px;text-decoration:none;font-size:0.88em;">📄 SIGGRAPH</a>
